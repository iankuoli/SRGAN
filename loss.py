...
def PSNRLoss(y_true, y_pred):
    ...
    return 48.1308036087 - 10. * K.log(K.mean(K.square(y_pred - y_true))) / K.log(10.0)


class ContentVGGRegularizer(ActivityRegularization):
...
class AdversarialLossRegularizer(ActivityRegularization):
...
class TVRegularizer(ActivityRegularization):
